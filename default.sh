...
args=(
  ...
  -drive file=/dev/sda,format=raw,if=none,id=tiny,cache=none,aio=native,discard=unmap
  -device ide-hd,bus=sata.4,drive=tiny
  -netdev tap,id=net0,ifname=tap0,script=no,downscript=no
  -device vmxnet3,netdev=net0,id=eth0,mac=52:54:00:c9:18:27
  -netdev tap,id=net1,ifname=tap1,script=no,downscript=no
  -device virtio-net,netdev=net1,id=eth1,mac=52:54:00:8e:e2:66,vectors=0
